...
def imageCropper(pokemonImage, spriteType, resizing, transparent):
    ...
    if spriteType == "Battle_Mons":
        ...
        croppedFront.save("front.png", "PNG")
        croppedFrontShiny.save("front_shiny.png")
        croppedBack.save("back.png")
        croppedShinyBack.save("back_shiny.png")




        # Transparency Clusterfuck...
        resizedFrontA = Image.open("front.png")
        ...
        if transparent:
            ...
            resizedFrontA.save("front.png", "PNG")

            #

        resizedFrontShinyA = Image.open("front_shiny.png")
        ...
        if transparent:
            ...
            resizedFrontShinyA.save("front_shiny.png", "PNG")

            ##

        resizedBackA = Image.open("back.png")
        ...
        if transparent:
            ...
            resizedBackA.save("back.png", "PNG")

            #

        resizedBackShinyA = Image.open("back_shiny.png")
        ...
        if transparent:
            ...
            resizedBackShinyA.save("back_shiny.png", "PNG")
        ...
        if resizing:
            ...
            resizedFront.save("front.png", "PNG")
            resizedFrontShiny.save("front_shiny.png")
            resizedBack.save("back.png")
            resizedShinyBack.save("back_shiny.png")
            
        # Moves the images to the appropriate folder
        shutil.copy("front.png", "output/000_EveryMon/Front")
        shutil.copy("front_shiny.png", "output/000_EveryMon/Front-Shiny")
        shutil.copy("back.png", "output/000_EveryMon/Back")
        shutil.copy("back_shiny.png", "output/000_EveryMon/Back-Shiny")
        
        shutil.move("front.png", "output/"+pokemonImage)
        shutil.move("front_shiny.png", "output/"+pokemonImage)
        shutil.move("back.png", "output/"+pokemonImage)
        shutil.move("back_shiny.png", "output/"+pokemonImage)
